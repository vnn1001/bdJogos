...
idEndereco int primary key not null auto-increment,
...
idTipoLocal int primary key not null auto-increment,
Descricao_TipoLocal varchar (30) not null;

create table Cliente(
idCliente int primary key not null auto-increment,
Pessoa_idPessoa int,
...
idTipoPessoa int primary key not null auto-increment,
Descricao_TipoPessoa varchar(20) not null;

create table Pessoa(
idPessoa int primary key not null auto-increment,
...
idContato int primary key not null auto-increment,
TipoLocal_idTipoLocal int not null,
Pessoa_idPessoa int not null,
...
create table jogos(
idJogos int primary key not null auto-increment,
Nome_Jogo varchar(30) not null,
Descricao_Jogo varchar (120) not null,
Genero_Jogo varcar (20) not null,
Produtora_Jogo varchar(40) not null;

create table VideoGame(
idVideoGame int primary key not null auto-increment,
Modelo_VideoGame varchar(20) not null,
NS_VideoGame varchar (24) not null;

create table Aluguel(
idAluguel int primary key not null auto-increment,
...
idFuncionario int primary key not null auto-increment,
Pessoa_idPessoa int not null,
